...
export const ABOUT_TEXT = `I am a dedicated and versatile full stack developer with a passion for creating efficient and user-friendly web applications.I have worked with a variety of technologies, including React, Redux, Redux Toolkit, etc. My journey in web development began with a deep curiosity for how things work, and it has evolved into a career where I continuously strive to learn and adapt to new challenges. I thrive in collaborative environments and enjoy solving complex problems to deliver high-quality solutions. Outside of coding, I enjoy staying active, exploring new technologies and different cloud services like Azure, AWS.`;
...
export const EXPERIENCES = [
  {
    ...
    company: "WORKZ, Dubai",
    description: `Developed and Maintained JavaCard Applets for global SIM/eSIM vendors. Providing Technical Support, Bug fixes and ensuring timely delivery. 
Responsible for supporting end to end testing of SIM(UICC).Support the investigation, troubleshooting and resolution of handset, card, network level issue 
Review test plans with development team. Reporting of identified inefficiencies and defaults.Conducting weekly client interactions to provide project status updates and gather requirements for future projects. 
Segregating customer data and creating data generation templates to support commercial production. Collaborated with cross-functional teams to streamline project workflows, contributing to a 10% increase in overall team productivity. 
Requirement gathering and client interaction for troubleshooting purpose.BAP Tracker reporting, where we provide updates on all ongoing projects to the Senior Management Team and set deadlines to meet customer timelines. `,
    technologies: ["Java Card, Native Card, Python,Beyond Compare", "UL Spy", "SDMS, SFT, KMS"],
  },
];
